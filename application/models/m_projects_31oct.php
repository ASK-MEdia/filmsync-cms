...
class M_Projects extends CI_Model{
        ...
        public function getThumbnailimage($url,$insertId)
        {
            ...
            if($video_type!=0)
            {
                ...
                {                     
                    ...
                    {                        
                      $thumbnail_imagename= 'no_image.gif';
                    }                   
	...
	{ 
        ...
        {          
            ...
            {  
                $files[].= BASE_PATH.'soundfiles/output/'.$result->id.'.wav';
            }
    ...
    {
        echo $sql = "delete from projects where id = '".$projectid."' ";
        $this->db->query($sql);
